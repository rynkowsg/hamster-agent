...
#ifndef __dbusxx__include_Hamster_proxy_hpp__PROXY_MARSHAL_H
#define __dbusxx__include_Hamster_proxy_hpp__PROXY_MARSHAL_H
...
public:
    ...
    std::vector< ::DBus::Struct< int32_t, int32_t, int32_t, std::string, std::string, int32_t, std::string, std::vector< std::string >, int32_t, int32_t, bool > > GetFacts(const uint32_t& start_date, const uint32_t& end_date, const std::string& search_terms, const uint32_t& limit, const bool& asc_by_date)
    {
        ::DBus::CallMessage call;
        ::DBus::MessageIter wi = call.writer();
...
#endif //__dbusxx__include_Hamster_proxy_hpp__PROXY_MARSHAL_H
